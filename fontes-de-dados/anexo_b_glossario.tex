...
\termo{Diferenças em diferenças (DID)}{
...
\termo{Linkagem de bases}{
Processo de combinar informações de duas ou mais bases de dados usando um identificador comum (como CPF, CNPJ ou código IBGE). Permite construir perfis multidimensionais de unidades de análise. Ver Capítulo~13.
}
...
Identificador único de cada pessoa cadastrada no CadÚnico. Usado para linkagem entre o CadÚnico e os registros de programas sociais como o Bolsa Família e o BPC.
}
...
\termo{Taxa de linkagem}{
Proporção de registros de uma base que foram vinculados com sucesso a registros de outra base em um processo de linkagem. Taxas baixas podem introduzir viés se os registros não linkados têm características sistemáticas diferentes.
}
