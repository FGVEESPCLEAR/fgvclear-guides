...
\begin{itemize}
  ...
  \item Impacto do saneamento sobre mortalidade infantil e diarreias;
...
A ANS disponibiliza dados sobre beneficiários de planos de saúde por município, faixa etária e sexo, operadoras ativas por modalidade e indicadores de qualidade assistencial (Idss). Para avaliações de políticas de saúde que afetam tanto o SUS quanto a saúde suplementar, os dados da ANS são indispensáveis para capturar o universo completo do setor.
...
Essas bases são \textbf{centrais em avaliações urbanas} porque permitem acompanhar transações imobiliárias com granularidade muito superior à das pesquisas nacionais. Para avaliações de impacto de projetos de infraestrutura urbana (como extensões de metrô, obras de saneamento, parques lineares) sobre os preços dos imóveis, de políticas de regularização fundiária sobre o mercado formal, ou de programas habitacionais sobre a dinâmica do entorno, as bases de ITBI são frequentemente insubstituíveis.
...
Para avaliações de políticas ambientais --- como o PPCDAm, a criação de unidades de conservação ou a implementação do CAR ---, o PRODES é a referência nacional e internacionalmente reconhecida.
...
\small
\begin{tabularx}{\textwidth}{@{} p{2.8cm} p{3.2cm} p{2cm} X @{}}
\toprule
...
Munic/Estadic & Capacidade institucional   & Municipal/estadual & Variável de controle institucional, habitação \\
...
Malhas IBGE  & Limites territoriais        & Todos os níveis    & Análise espacial, visualização, linkagem \\
...
PRODES/INPE  & Desmatamento                & Amazônia/Brasil    & Políticas ambientais \\
DETER/INPE   & Alertas de desmatamento     & Amazônia/Cerrado   & Fiscalização ambiental \\
...
\begin{itemize}
  ...
  \item As \textbf{malhas territoriais e setores censitários} do IBGE são a base para qualquer análise espacial e, frequentemente, o único caminho para linkar fontes que não compartilham identificadores administrativos comuns;
