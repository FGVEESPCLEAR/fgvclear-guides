...
Os microdados do SAEB são disponibilizados gratuitamente pelo Inep após cada edição da avaliação. Os arquivos contêm as notas individuais dos alunos, as respostas ao questionário contextual e os identificadores de escola e município. A anonimização impede a identificação direta dos alunos, mas os identificadores de escola permitem a linkagem com o Censo Escolar.
...
\small
\begin{tabularx}{\textwidth}{@{} p{2.5cm} p{3cm} p{2cm} X @{}}
\toprule
...
A escola é muitas vezes o primeiro ponto de contato do Estado com as crianças mais vulneráveis — e também o lugar onde a falta de renda em casa se manifesta em frequência irregular, abandono e baixo desempenho. As políticas de assistência social e transferência de renda existem, em parte, para romper esse ciclo. O próximo capítulo apresenta o CadÚnico, o Bolsa Família, o BPC e o SUAS: as fontes que permitem identificar quem são as famílias atendidas, quais são seus perfis e o que muda na vida delas com o acesso aos programas.