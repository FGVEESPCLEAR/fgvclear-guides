...
CEPALSTAT/BADEHOG & CEPAL                & 33 países AL       & Comparações regionais, microdados \\
...
As fontes tradicionais cobrem um vasto território, mas há um ecossistema emergente que as complementa e, em alguns casos, transforma: dados estruturados com apoio de APIs governamentais, \textit{web scraping} e inteligência artificial. Essas ferramentas não substituem as fontes institucionais --- elas preenchem lacunas, aceleram a coleta e criam possibilidades analíticas novas que seriam impraticáveis sem elas. O capítulo seguinte discute como aproveitá-las com rigor metodológico.