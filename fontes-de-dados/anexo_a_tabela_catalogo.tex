...
{\setlength{\tabcolsep}{3pt}\footnotesize\begin{longtable}{@{} >{\raggedright\arraybackslash}p{2.9cm} >{\raggedright\arraybackslash}p{2.3cm} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{1.1cm} >{\raggedright\arraybackslash}p{3.2cm} @{}}
\toprule
...
eSocial
  & MTE\slash \allowbreak RFB\slash \allowbreak INSS
  & Brasil
  & Contínuo (2018--)
  & Conv
  & \url{gov.br/esocial} \\
...
SISAB --- Atenção Básica
  & MS/SAPS
  & Brasil, UF, município, equipe
  & Cont. (2013--)
  & A
  & \url{sisab.saude.gov.br} \\
...
Plataforma Nilo Peçanha (PNP)
  ...
  & Anual (2018--)
  & A
  & \href{https://plataformanilopecanha.mec.gov.br}{\nolinkurl{plataforma-nilopecanha.mec.gov.br}} \\
...
Penn World Table (PWT)
  & Univ. Groningen / UPenn
  & 180+ países
  & Anual (1950--)
  & A
  & \url{rug.nl/ggdc/productivity/pwt} \\
...
WHO Mortality Database
  & OMS
  & Países que reportam à OMS
  & Anual
  & A
  & \url{who.int/data/data-collection-tools/who-mortality-database} \\
...
{\setlength{\tabcolsep}{3pt}\footnotesize\begin{longtable}{@{} >{\raggedright\arraybackslash}p{3.2cm} >{\raggedright\arraybackslash}p{2cm} >{\raggedright\arraybackslash}p{4cm} >{\raggedright\arraybackslash}p{1cm} >{\raggedright\arraybackslash}p{3cm} @{}}
\toprule
\textbf{Canal\slash Ferramenta} & \textbf{Mantenedor} & \textbf{Função} & \textbf{Acesso} & \textbf{URL} \\
\midrule
\endfirsthead
...
{\setlength{\tabcolsep}{3pt}\footnotesize\begin{longtable}{@{} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{2.3cm} >{\raggedright\arraybackslash}p{4.2cm} >{\raggedright\arraybackslash}p{1cm} >{\raggedright\arraybackslash}p{3cm} @{}}
\toprule
...
QEdu
  & Meritt\slash \allowbreak Fundação Lemann
