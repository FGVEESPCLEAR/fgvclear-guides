...
Registros estaduais & Boletins de ocorrência       & Estadual/municipal   & Análises locais, policiamento \\
DEPEN/SISDEPEN      & População carcerária         & Nacional             & Sistema prisional, encarceramento \\
...
A violência é profundamente territorial: concentra-se em bairros específicos, em certos municípios, ao longo de determinadas rodovias. Compreender esses padrões exige uma camada de análise que vai além do evento criminal em si --- exige enxergar o território onde ele ocorre, a infraestrutura disponível, as distâncias que separam os moradores dos serviços públicos. O próximo capítulo apresenta as fontes que permitem essa leitura espacial: malhas territoriais do IBGE, SNIS, dados de agências reguladoras e informações ambientais do INPE.