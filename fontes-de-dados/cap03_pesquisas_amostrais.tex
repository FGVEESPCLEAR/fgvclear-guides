...
\begin{itemize}
  ...
  \item \textbf{Questionário amostral}: aplicado a uma fração dos domicílios (aproximadamente 10\% a 20\%, dependendo do porte do município). Contém um conjunto muito mais amplo de variáveis, incluindo:
  \begin{itemize}
...
A documentação metodológica completa da PNADC está disponível em \url{ftp.ibge.gov.br/Trabalho_e_Rendimento/Pesquisa_Nacional_por_Amostra_de_Domicilios_continua/Notas_metodologicas/notas_metodologicas.pdf} e deve ser consultada antes de qualquer análise que envolva domínios de estimação não convencionais.
...
\small
\begin{tabularx}{\textwidth}{@{} p{2.8cm} p{2.2cm} p{2cm} X @{}}
\toprule
...
PNAD Contínua        & 2012--atual & Trimestral/anual & Mercado de trabalho, educação, habitação, pobreza (Brasil, regiões, UFs) \\
