...
# Estimando a regressão conforme Sun & Abraham ----------------------------
##TWFE regresssão
...
# Renomeando e armazenando ATT(g,t) para facilitar sua agregação ----------
...
# Usando o Delta Method para inferência de qualquer ponderação ------------
##Construindo a função que aplica o método para média ponderada
...
for(tt in 2012:2020){
  ...
  #1 se ATT for p periodos apos a intervenção, 0 caso contrário.
...
##Efeito por período adicional de tratamento (dynamic)
